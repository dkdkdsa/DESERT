...
Shader "FORGE3D/WarpTunnel"
{
	Properties
	{
		...
		[ASEBegin]_TintA("TintA", Color) = (1,1,1,1)
		...
		[ASEEnd]_FadeMax("FadeMax", Float) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				float2 panner7 = ( ( _TimeParameters.x ) * appendResult14 + uv_Mask);
				...
				float4 temp_output_4_0 = ( max( float4( 0,0,0,0 ) , pow( abs( lerpResult18 ) , temp_cast_0 ) ) * packedInput.ase_color * packedInput.ase_color.a * tex2DNode17 * _Boost * ( 1.0 - smoothstepResult40 ) );
				
				surfaceDescription.Color = temp_output_4_0.rgb;
				surfaceDescription.Emission = temp_output_4_0.rgb;
...
/*ASEBEGIN
Version=18912
-1920;0;1920;1139;1105.994;969.1529;1.3;True;False
Node;AmplifyShaderEditor.TexturePropertyNode;16;-1704,-122;Float;True;Property;_Mask;Mask;4;0;Create;True;0;0;0;False;0;False;None;0254c2a6a631a41498dceb75602bc58a;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.SamplerNode;17;-682,-113;Inherit;True;Property;_TextureSample0;Texture Sample 0;1;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.AbsOpNode;55;166.7056,-667.5529;Inherit;False;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;30;487.0671,-261.0545;Float;False;Property;_Boost;Boost;5;0;Create;True;0;0;0;False;0;False;0.04;0.65;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TimeNode;8;-1238,135;Inherit;False;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;27;-88,-687;Float;False;Property;_Exp;Exp;6;0;Create;True;0;0;0;False;0;False;0.04;0.66;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;11;-1255,-188;Float;False;Property;_UTile;UTile;2;0;Create;True;0;0;0;False;0;False;0;-0.12;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.WorldSpaceCameraPos;33;-213.6328,41.84901;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.RangedFloatNode;12;-1238,-52;Float;False;Property;_VTile;VTile;3;0;Create;True;0;0;0;False;0;False;0;-0.64;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;19;-671,-336;Float;False;Property;_TintB;TintB;1;0;Create;True;0;0;0;False;0;False;1,1,1,1;0,0.5448273,1,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMaxOpNode;29;692.8,-611.3999;Inherit;False;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=5CE0F46EAEDA57EFBD6A424C080311C1E83F5764