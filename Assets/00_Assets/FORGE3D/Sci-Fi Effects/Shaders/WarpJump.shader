	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				float4 temp_output_11_0 = ( lerpResult10 * tex2DNode7 * packedInput.ase_color * packedInput.ase_color.a * saturate( distanceDepth13 ) );
...
/*ASEBEGIN
Version=18912
-1920;0;1920;1139;1001;855.5;1;True;False
...
ASEEND*/
//CHKSM=61AE3A2C94B02F7BD585991E5E30DA951374C937