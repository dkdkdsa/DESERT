	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float2 uv_LoopTex = packedInput.ase_texcoord.xy * _LoopTex_ST.xy + _LoopTex_ST.zw;
				float2 panner13_g55 = ( 1.0 * _Time.y * _LoopTexPanSpeed + uv_LoopTex);
				float4 LoopTex33_g55 = ( tex2D( _LoopTex, panner13_g55 ) * _LoopTexMult );
				float2 uv_MaskTex = packedInput.ase_texcoord.xy * _MaskTex_ST.xy + _MaskTex_ST.zw;
				float4 tex2DNode4_g55 = tex2D( _MaskTex, uv_MaskTex );
				float4 _Vector2 = float4(15,1,0,0);
				float2 uv_BurnoutMask = packedInput.ase_texcoord.xy * _BurnoutMask_ST.xy + _BurnoutMask_ST.zw;
				float dotResult63_g55 = dot( tex2D( _BurnoutMask, uv_BurnoutMask ) , float4( float3(0.22,0.707,0.071) , 0.0 ) );
...
/*ASEBEGIN
Version=18912
-1920;0;1920;1139;795.8497;1294.665;1;True;False
...
ASEEND*/
//CHKSM=C743652AB8F74F1674790A6E606368450AFEF950