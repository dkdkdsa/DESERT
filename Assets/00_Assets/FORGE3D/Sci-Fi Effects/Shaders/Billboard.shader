	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				float distanceDepth3 = abs( ( screenDepth3 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( _InvFade ) );
				float4 temp_output_8_0 = ( ( tex2D( _MainTex, uv_MainTex ) * _Tint * packedInput.ase_color ) * saturate( distanceDepth3 ) );
				
				surfaceDescription.Color = temp_output_8_0.rgb;
				surfaceDescription.Emission = temp_output_8_0.rgb;
...
/*ASEBEGIN
Version=18912
-1920;0;1920;1139;1525;365.5;1;True;False
Node;AmplifyShaderEditor.RangedFloatNode;1;-1067.25,368.125;Float;False;Property;_InvFade;InvFade;2;0;Create;True;0;0;0;False;0;False;0;3;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;4;-849.25,-256.875;Inherit;True;Property;_MainTex;MainTex;0;0;Create;True;0;0;0;False;0;False;-1;None;4812430cc74f7c0419badaa3e2378bc4;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;5;-847.25,-55.875;Float;False;Property;_Tint;Tint;1;0;Create;True;0;0;0;False;0;False;1,1,1,1;1,1,1,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;9;6;16;0
ASEEND*/
//CHKSM=0521471098DDE192316BB550E769731FC77D7BEE