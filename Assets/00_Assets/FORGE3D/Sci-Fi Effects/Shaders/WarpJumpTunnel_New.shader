	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				float screenDepth13 = LinearEyeDepth(SampleCameraDepth( ase_screenPosNorm.xy ),_ZBufferParams);
				float distanceDepth13 = abs( ( screenDepth13 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( _InvFade ) );
				float4 temp_output_11_0 = ( lerpResult10 * tex2DNode7 * packedInput.ase_color * packedInput.ase_color.a * saturate( distanceDepth13 ) * _Alpha );
...
/*ASEBEGIN
Version=18912
-1920;0;1920;1139;325;700.5;1;True;False
...
ASEEND*/
//CHKSM=E6213C83EF9872FB62ED6D1A9FDE2990A731A199