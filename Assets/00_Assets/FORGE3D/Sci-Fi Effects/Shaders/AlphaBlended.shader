	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				float screenDepth6 = LinearEyeDepth(SampleCameraDepth( ase_screenPosNorm.xy ),_ZBufferParams);
				float distanceDepth6 = abs( ( screenDepth6 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( _InvFade ) );
				
				surfaceDescription.Color = ( tex2DNode5 * _Tint * packedInput.ase_color ).rgb;
				surfaceDescription.Emission = 0;
				surfaceDescription.Alpha = ( tex2DNode5.a * _Tint.a * saturate( distanceDepth6 ) * packedInput.ase_color.a );
...
/*ASEBEGIN
Version=18912
-1920;0;1920;1139;2191.505;2373.97;2.571573;True;False
...
ASEEND*/
//CHKSM=3DC8170CD965B22A28A0C86F7507EFD411DC7BA2