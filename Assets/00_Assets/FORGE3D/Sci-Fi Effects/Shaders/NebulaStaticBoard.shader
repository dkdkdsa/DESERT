...
Shader "FORGE3D/Billboard Nebula"
{
	Properties
	{
		...
		[ASEEnd]_Fade("Fade", Vector) = (0,0,0,0)
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				float3 worldToObjDir59 = mul( GetWorldToObjectMatrix(), float4( V, 0 ) ).xyz;
				float3 normalizeResult60 = normalize( worldToObjDir59 );
				float dotResult11 = dot( normalizeResult60 , packedInput.ase_normal );
				float smoothstepResult19 = smoothstep( _Min , _Max , abs( dotResult11 ));
				float temp_output_18_0 = saturate( smoothstepResult19 );
				
				float3 worldToObj52 = mul( GetWorldToObjectMatrix(), float4( GetCameraRelativePositionWS(_WorldSpaceCameraPos), 1 ) ).xyz;
				float temp_output_5_0_g1 = distance( packedInput.ase_texcoord2.xyz , worldToObj52 );
				...
				surfaceDescription.Color = ( ( tex2DNode7 * temp_output_18_0 ) * _Boost * _Color0 * packedInput.ase_color * packedInput.ase_color.a ).rgb;
				surfaceDescription.Emission = 0;
				surfaceDescription.Alpha = saturate( ( tex2DNode7.a * temp_output_18_0 * _Alpha * ( smoothstepResult13_g1 - smoothstepResult25_g1 ) ) );
...
/*ASEBEGIN
Version=18912
-1920;0;1920;1139;712.1082;622.3226;1.416629;True;False
...
Node;AmplifyShaderEditor.TransformDirectionNode;59;-957.894,-218.5836;Inherit;False;World;Object;False;Fast;False;1;0;FLOAT3;0,0,0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.NormalizeNode;60;-782.2323,12.32697;Inherit;False;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;17;-285.7,332.6999;Inherit;False;Property;_Min;Min;1;0;Create;True;0;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;20;-283.7,421.6999;Inherit;False;Property;_Max;Max;2;0;Create;True;0;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector4Node;48;1284.878,695.2414;Inherit;False;Property;_Fade;Fade;9;0;Create;True;0;0;0;False;0;False;0,0,0,0;25,300,300,350;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;46;701.8281,-515.0585;Inherit;False;Property;_Alpha;Alpha;8;0;Create;True;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;7;-493,-160.5;Inherit;True;Property;_Mask;Mask;0;0;Create;True;0;0;0;False;0;False;-1;None;e2f88074379c8544aa1eaf0346ed990d;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SaturateNode;18;145.4001,108.9;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;29;1003.913,-85.57468;Inherit;False;4;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;44;53.1282,-487.7585;Inherit;False;Property;_Color0;Color 0;7;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;22;773.4337,-333.7297;Inherit;False;5;5;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.VertexColorNode;61;73.41245,-285.1652;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TransformDirectionNode;57;-1263.429,244.7246;Inherit;False;Object;World;False;Fast;False;1;0;FLOAT3;0,0,0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.RangedFloatNode;23;324.1703,-307.6163;Inherit;False;Property;_Boost;Boost;3;0;Create;True;0;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;21;263.022,-132.9847;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;42;530.2281,562.6418;Inherit;False;Property;_Length;Length;5;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;32;1152.869,-76.70527;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;31;55.72858,392.3415;Inherit;False;Property;_Distance;Distance;4;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=94AC374D97B58E907F4C22A6115141D968DAE92D